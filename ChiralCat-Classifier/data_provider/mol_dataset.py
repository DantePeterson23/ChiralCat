...
class MolDataset(Dataset):
    ...
    def get_3d(self, index):
        atom_vec, coordinates, edge_type, dist, smiles, description, enriched_description, label = self.d3_dataset[self.cid_list[index]]
        ...
        return (atom_vec, coordinates, edge_type, dist, smiles), return_description, label
