...
class Stage1DM(LightningDataModule):
    def __init__(
        ...
        if args.mode == 'pretrain':
            self.train_dataset = MolDataset(root+'/pretrain/', text_max_len, dictionary, args.unimol_max_atoms, enriched_descrption=args.enriched_descrption)
        else:
            self.train_dataset = MolDataset(root+'/train/', text_max_len, dictionary, args.unimol_max_atoms)
        self.val_dataset = MolDataset(root + '/valid/', text_max_len, dictionary, args.unimol_max_atoms)
        self.val_dataset_match = MolDataset(root + '/valid/', text_max_len, dictionary, args.unimol_max_atoms)
        self.test_dataset_match = MolDataset(root + '/test/', text_max_len, dictionary, args.unimol_max_atoms)
